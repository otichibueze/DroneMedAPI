...
public class DroneServiceImpl implements DroneService {
    ...
    @Override
    public List<Optional<Drone>> findDroneByState(Drone.State state) {
        return droneRepository.findDronesByState(state);
    }

    @Override
    public List<Optional<Drone>> findDronesByModel(Drone.Model model) {
        return droneRepository.findDronesByModel(model);
    }

    @Override
    public List<Optional<Drone>> findDronesByBatteryCapacityAfter(int percentage) {
        return droneRepository.findDronesByBatteryCapacityAfter(percentage);
    }
